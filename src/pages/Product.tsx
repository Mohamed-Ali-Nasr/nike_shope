...
const Product = () => {
  ...
  return (
    <div
      style={{ boxShadow: "0px 15px 50px 10px rgba(0, 0, 0, 0.4" }}
      className="relative md:mt-0 mt-12 bg-[#024742] items-center w-full m-auto md:h-[unset] productPage"
    >
      {productInfo ? (
        <>
          ...
          <section className="sm-x2:mt-10 py-20 mt-32 bg-white">
            ...
            <main className="flex flex-wrap lg:mx-10 sm-x2:!mx-5 justify-center gap-12">
              ...
              >
                ...
                <p className=" text-[13px] mt-8 tracking-tight  ">
                  ...
                  request a different size/color or model.
                </p>
              </div>
            </main>
          </section>
