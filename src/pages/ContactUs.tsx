...
const ContactUs = () => {
  return (
    <div className="mt-20">
      <section className="bg-[#2a6e6a] pt-36 pb-10 flex justify-around lg:flex-col-reverse lg:justify-center lg:px-5">
        <div className="lg:mt-10 relative space-y-8">
      ...
      <section className="bg-[#fdfdfd] py-16 flex items-center justify-around md:flex-col md:pb-32 md:justify-center">
        <div className="relative">
          ...
          <img
            className="w-[700px]  lg:w-[500px]   sm:!w-[310px]"
            src="/images/graph.png "
            alt="graph"
          />
        </div>

        <main className="sm-x2:pt-10 space-y-6">
          <div
            style={{
              boxShadow:
                "12px 12px 26px rgba(0, 0, 0, 0.2),-12px -12px 26px rgba(255, 255, 255, 0.6)",
            }}
            className="relative w-[300px] text-[rgb(0,59,8)] z-[999] border-[rgb(0,59,8)] border-solid border-r border-b rounded-3xl p-8 bg-[#fff] "
          >
      ...
      <section className="bg-white px-28 text-[20px] sm-x2:px-6 sm-x2:text-center leading-8 pb-20">
        <p>
          ...
          shoes for a reasonable price. If you buy something on our site you are
          always protected via every payment option, you are always able to get
          your money back if something goes wrong. We also offer 14-day returns,
          if you don’t like the product or the shoes don't fit, you can send it
          back to us with ease.{" "}
        </p>
        <p className="mt-6">
          We care about the authenticity of our products. We do not sell fakes
          and do not support the trade of fakes either. We only buy our products
          from official retailers to make sure everything is 100% authentic.{" "}
        </p>
      </section>
    </div>
  );
