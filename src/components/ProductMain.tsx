...
const ProductMain = (props: product) => {
  ...
  return (
    <>
      <div
        style={{
          background: `linear-gradient(135deg, ${props.bg} 8%, #2a6e6a 83%)`,
          borderRadius: "0% 50% 50% 0%",
        }}
        className="h-[500px] sm:h-[300px] md:w-full md:!rounded-none md:relative w-[400px] flex items-center absolute z-[5] bg-[#ff6d39] mr-[93px]"
      >
        <Swiper
          pagination={{
            dynamicBullets: true,
      ...
      <div className="h-[500px] relative sm-x2:!h-full bg-[#ffffff] lg:w-[700px] md:!w-full md:ml-0 w-[800px] z-[3] ml-[200px] content">
        <div className=" absolute md:relative sm-x2:!h-full sm-x2:pb-10 md:right-0 sm-x2:!px-4 md:px-8 md:w-full top-1 right-[64px] h-[500px] w-[400px] z-10">
          <div className="flex justify-between pt-5">
            ...
            <SiJordan className="text-[#024742] relative md:left-0 left-8 text-2xl" />
          </div>

          <div className="uppercase">
            <h3 className="mt-16">designed by {props.Designed_by}</h3>
            <p className="sm-x2:whitespace-break-spaces whitespace-nowrap my-4 text-3xl">
              {props.title}
            </p>

            <section className="sm-x2:flex-col sm-x2:gap-5 flex justify-between">
          ...
          <div className="sm-x2:mt-5 gap-9 flex justify-between my-3">
            <p>SIZE</p>
            <ul className="flex gap-2">
              {props.size.map((data) => (
                <li key={crypto.randomUUID()} className="text-[14px]">
                  {data}
                </li>
              ))}
            </ul>
                ...
                <div key={crypto.randomUUID()}>
                  {data.id == props.id ? (
                      ...
                      <section className="flex gap-8">
                        <div className="flex justify-between items-center gap-3 w-[60px]">
                          <span
                            ...
                            className="cursor-pointer px-[1px] text-[20px]"
                          >
                            -
                          </span>
                        ...
                        <BiSolidTrashAlt
                          ...
                          className="text-[20px] cursor-pointer text-1xl text-red-600 relative top-[2px]"
                        />
                      </section>
                    </div>
                  ) : (
                    <button
                      ...
                      className="bg-[#024742] mt-14 w-full rounded-lg py-2 text-white"
                    >
                      Add To Cart
                    </button>
                  )}
